import numpy as np
from environments import gurobiutils
from environments.solverutils import computeoptimaltab, generatecutzeroth
import time
...
def make_multiple_env(load_dir, idx_list, timelimit, reward_type, seed=0):
	envs = []
	for idx in idx_list:
		...
		envs.append(env)
	env_final = MultipleEnvs(envs, seed=seed)
	return env_final
